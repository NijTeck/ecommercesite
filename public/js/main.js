...
//INFORMATION
var FRUIT = [
    {name:'GalaxyFlip',price:1},
    {name:'GalaxyS10',price:1},
    {name:'Galaxy20',price:1},
    {name:'Galaxy30',price:1},
];

var JUICE = [
    {name:'Iphone5',price:1},
    {name:'Iphone10',price:1},
    {name:'Iphone20',price:1},
    {name:'Iphone30',price:1},
];

var SALAD = [
    {name:'Pixel5',price:1},
    {name:'Pixel10',price:1},
    {name:'Pixel20',price:1},
    {name:'Pixel30',price:1},
];
            ...
            <div class="card mb-4 shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        '${FRUIT[con-1].price}','${URL}','${com}','${btn}')"
                        class="btn btn-sm btn-outline-secondary" > <a style="color:inherit;" href="/cart">But</a></button>
...
// cartItems.push(item);
// let stroage= JSON.parse(localStorage.getItem("cart"));
// if (Storage==null) {
//     products.push(item);
//     localStorage.setItem("cart", JSON.stringify(products));
// } else { 
